...
export DEPLOY_ENV_TPLS=".env.aqua.tpl .env.aqua.host.tpl"
export DEPLOY_BUILD_CMD='bun run build'
export DEPLOY_BUN_ENV_FILES=".env.aqua.local .env.aqua.host.local"
export DEPLOY_SYSTEMD_UNIT_SRC="${DEPLOY_ROOT}/../deploy/systemd/aqua-nozero.service"
